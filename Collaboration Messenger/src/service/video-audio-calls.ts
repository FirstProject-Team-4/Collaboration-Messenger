 ...
 * @param group - The group object containing the group ID and title.
...
/**
 * Sends a participant token to join a room.
...
/**
 * Sends a private participant token to a specific room.
 * @param room - The room object containing the room ID.
 * @param member - The member object containing the member details.
