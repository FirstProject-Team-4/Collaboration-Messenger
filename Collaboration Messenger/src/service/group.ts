 ...
 * @param currentGroup - The data for the new group.
 ...
 * @returns {Promise<Array<Object>>} An array of public groups.
 */
 ...
 * @returns A promise that resolves to an array of MembersProps.
 */
...
/**
 * Joins a group by updating the necessary database references and sending a participant token.
